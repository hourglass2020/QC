...
public class InstallDeviceScene2 extends UI_Scene
{
    ...
    public InstallDeviceScene2() throws IOException
    {
    ...
    private void init() throws FileNotFoundException {
        ...
        hbButtons.getChildren().addAll(btnBack, btnClear, btnMainAdd , btnNext);
    ...
    private class NextBtnEvent implements EventHandler {
        ...
        public void handle(Event event) {
            ...
            try {
                InstallDeviceScene3 newScene = new InstallDeviceScene3();
    ...
    private class BackBtnEvent implements EventHandler
    {
        ...
        public void handle(Event event)
        {
            ...
            alert.setHeaderText("");
            alert.setContentText("If you back, your inserted attributes are lost.\n\nDo you continue?");
            Stage stage = (Stage)alert.getDialogPane().getScene().getWindow();
            try {
                stage.getIcons().add(new Image(new FileInputStream(QCConstantValues.TITLES[16])));
            } catch (FileNotFoundException e) {
            ...
            {
                company.getMainDevice().setAddedAttributes(new ArrayList<>());
