...
public class ProjectDeviceScene extends UI_Scene
{
    ...
    public ProjectDeviceScene(Device deviceType) throws IOException
    {
...
//            System.out.println(result);
            ...
            System.out.println(this.device.getEngNameOfDevice());
            QCStructure.getStructure().setNewDevice(this.device);
            QCStructure.getStructure().setAttributes(this.device);
