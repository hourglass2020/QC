...
public class FastReportDeviceScene extends UI_Scene {
    ...
    public FastReportDeviceScene(Device deviceType) throws IOException
    {
...
//        mainGrid.setPadding(new Insets(10, 10, 10, 10));
        ...
        titleImage = new Image(new FileInputStream("Resources/fastReportPanelIco2.png"));
...
//        btnClear.setOnMouseClicked(new ClearBtnEvent(tempDevice));
        init("" , tempDevice);
...
//        counter++;
    ...
    private class AddBtnEvent implements EventHandler
    {
        ...
        public void handle(Event event)
        {
            ...
            else if (result.toString().equalsIgnoreCase("conditional"))
            {
            ...
            try {
                UI_Scene newScene = new FastReportResultScene();
                Stage next_scene = (Stage) ((Node) event.getSource()).getScene().getWindow();
                QCMap.getMap().setDecoratorContent(newScene.get_Scene());
                next_scene.setTitle("Fast Report Page");
                next_scene.centerOnScreen();
