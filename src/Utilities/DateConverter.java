...
public class DateConverter {
    ...
    public static String getDate(String dateStr) {
        ...
        LocalDateTime myDateObj = LocalDateTime.of(Integer.parseInt(dateStr.substring(0, 4)),
                Integer.parseInt(dateStr.substring(5, 7)),
                Integer.parseInt(dateStr.substring(8, 10)), 00, 00);
        DateTimeFormatter myFormatObj = DateTimeFormatter.ofPattern("yyyy-MM-dd");

//        String formattedDate = myDateObj.format(myFormatObj);
//        Locale loc = myFormatObj.getLocale();

        DateConverter converter = new DateConverter();
        converter.gregorianToPersian(myDateObj.getYear(), myDateObj.getMonthValue(), myDateObj.getDayOfMonth());

        return (String)(converter.jYear + "/" + converter.jMonth + "/" + converter.jDay);
